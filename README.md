...
1. Navigate to your user folder: `C:\Users\LENOVO`
2. Create a new text file and name it `vansh.bat` (make sure it doesn't end in `.txt`).
3. Open `vansh.bat` in Notepad, paste the following content, and Save:
```bat
@echo off
